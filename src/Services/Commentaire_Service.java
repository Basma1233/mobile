...
public class Commentaire_Service {
    ...
    public Commentaire_Service() {
       ...
       public boolean addEvent(Commentaire commentaire) {
        ...
        String url = Statics.BASE_URL + "/Comments/new/"+commentaire.getIdEvt()+"/"+commentaire.getId()+"?commentaire="+ commentaire.getComment();
        request.setUrl(url);
        ...
        String url = Statics.BASE_URL + "/Comments/All/"+id;
       ...
       public boolean ModifierComment(Commentaire c) {
        ...
        String url = Statics.BASE_URL + "/Comments/update/"+c.getIdComment()+"?commentaire="+c.getComment();
