...
public class Participe_Service {
    ...
    public Participe_Service() {
        ...
        String url = Statics.BASE_URL + "/Participe/new/"+p.getIdEvent()+"/"+p.getIdUuser();
        request.setUrl(url);
        ...
        String url = Statics.BASE_URL + "/Participe/delete/"+ide+"/"+idu;
     ...
     public ArrayList<Participer> getParticipantByUser(int ide , int idu) {
        String url = Statics.BASE_URL + "/Participe/find/"+ide+"/"+idu;
